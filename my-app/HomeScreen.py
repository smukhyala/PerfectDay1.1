...
class HomeTextBot(ft.UserControl):
    ...
    def build(self):
        ...
        self.AppDesc = ft.Text('At the top of your screen you will see tappable icons. These icons can be used to navigate to different components of PerfectDay. You can make activities, manage your email and communication preferences, and eventually save CURRENT weather conditions. This project was developed using Flet. Contact smukhyala@gmail.com for quesitons about the app and feature requests.', #edit and delete them
